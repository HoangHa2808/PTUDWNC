...
namespace TatBlog.Services.Authors
{
    public interface IAuthorRepository
    {
        ...
        Task<IPagedList<AuthorItem>> GetPagedAuthorsAsync(int pageNumber = 1,
            int pageSize = 10, CancellationToken cancellationToken = default);

        Task<bool> DeleteAuthorByIdAsync(int categoryId,CancellationToken cancellationToken = default);
